...
function calculate() { 
	...
	if (materialChoice === "Aluminum") {
		if (machineFactor === 2){ 
			feedRateInches = (Number(Aluminum[0][cutterChoice])*speedRate*numberOfFlutes*1.6);
			if (feedRateInches > 320){
				feedRateInches = 320;
			}
		} else {
	...
	if (materialChoice === "Hard_Plastic") {
		if (machineFactor === 2){
			feedRateInches = (Number(Hard_Plastic[0][cutterChoice])*Number(speedChoice)*Number(flutesChoice)*2);
			if (feedRateInches > 320){
				feedRateInches = 320;
			}
		} else {
	...
	if (materialChoice === "Hardwood") {
		if (machineFactor === 2){
			feedRateInches = (Number(Hardwood[0][cutterChoice])*Number(speedChoice)*Number(flutesChoice)*2);
			if (feedRateInches > 320){
				feedRateInches = 320;
			}
		} else {
	...
	if (materialChoice === "MDF") {
		if (machineFactor === 2){
			feedRateInches = (Number(MDF[0][cutterChoice])*Number(speedChoice)*Number(flutesChoice)*2);
			if (feedRateInches > 320){
				feedRateInches = 320;
			}
		} else {
	...
	if (materialChoice === "Soft_Plastic") {
		if (machineFactor === 2){
			feedRateInches = (Number(Soft_Plastic[0][cutterChoice])*Number(speedChoice)*Number(flutesChoice)*2);
			if (feedRateInches > 320){
				feedRateInches = 320;
			}
		} else {
	...
	if (materialChoice === "Softwood") {
		if (machineFactor === 2){
			feedRateInches = (Number(Softwood[0][cutterChoice])*Number(speedChoice)*Number(flutesChoice)*2);
			if (feedRateInches > 320){
				feedRateInches = 320;
			}
		} else {
...
function calcSFPM(){
	...
	if (cutSpeed == "1") { 
		...
		var diam1 = parseFloat((sfpm*12/(pi*rpm)).toFixed(4));
	...
	if (cutSpeed == "2") {
		  ...
		  if ( errorMsg != "" ) {
			...
			return;
				...
				var rpm1 = parseFloat((sfpm*12/(pi*diam))).toFixed(0);
	...
	if (cutSpeed == "3") {
		  ...
		  if ( errorMsg != "" ) {
			...
			return;
				...
				var sfpm1 = parseFloat((((pi*rpm*diam)/12)*100)/100).toFixed(4);
